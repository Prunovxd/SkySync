...
@__DSOCacheEntry_name.8 = internal constant [22 x i8] c"libaot-SkySync.dll.so\00", align 1
...
@__DSOCacheEntry_name.23 = internal constant [25 x i8] c"libaot-Plugin.BLE.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [464 x %struct.DSOCacheEntry] [
	...
	; 7
	%struct.DSOCacheEntry {
		i64 123459646, ; hash 0x75bd83e, from name: SkySync
		i8 0, ; ignore
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.23, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 25
	%struct.DSOCacheEntry {
	...
	; 55
	%struct.DSOCacheEntry {
		i64 549515623, ; hash 0x20c0f167, from name: libaot-SkySync.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 64
	%struct.DSOCacheEntry {
		i64 633805560, ; hash 0x25c71af8, from name: libaot-SkySync
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 164
	%struct.DSOCacheEntry {
		i64 1605215151, ; hash 0x5fada3af, from name: aot-SkySync
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 184
	%struct.DSOCacheEntry {
		i64 1780627895, ; hash 0x6a2239b7, from name: aot-SkySync.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 444
	%struct.DSOCacheEntry {
		i64 4113306627, ; hash 0xf52c1403, from name: SkySync.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
