...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"5ec0f631-b9e4-4e25-8a1a-56f5f606c59f\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [20 x i8] c"com.SkySync.SkySync\00", align 16
...
@__DSOCacheEntry_name.53 = internal constant [22 x i8] c"libaot-SkySync.dll.so\00", align 16
...
@__DSOCacheEntry_name.63 = internal constant [25 x i8] c"libaot-Plugin.BLE.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [464 x %struct.DSOCacheEntry] [
	...
	; 75
	%struct.DSOCacheEntry {
		i64 3293791533161756154, ; hash 0x2db5e5f2ba4bb5fa, from name: libaot-SkySync.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.53, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 76
	%struct.DSOCacheEntry {
	...
	; 117
	%struct.DSOCacheEntry {
		i64 5247174326445183452, ; hash 0x48d1b53fca5091dc, from name: libaot-SkySync
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.53, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 304
	%struct.DSOCacheEntry {
		i64 12553242627754810659, ; hash 0xae3613a8f69ddd23, from name: SkySync.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.53, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 362
	%struct.DSOCacheEntry {
		i64 14427408333703337527, ; hash 0xc838737097e5d637, from name: SkySync
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.53, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 431
	%struct.DSOCacheEntry {
		i64 17397182529034034419, ; hash 0xf16f3555ffb49cf3, from name: aot-SkySync.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.53, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 442
	%struct.DSOCacheEntry {
		i64 17893210354704672654, ; hash 0xf8517403eb83678e, from name: aot-SkySync
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.53, i32 0, i32 0), ; name
		i8* null; handle
	}, 
